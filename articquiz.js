...
function getNewArtPiece () {
    ...
    .then(articJson => {
        //there are 10 records per page in the search results, so this will pick a random record within the random
        //page
        ...
        if (articData2.image_id == null || date < 1850) {
            ...
            console.log(title)
            console.log(date)
            //draw the image (again, may change this later but it's currently working realatively well)
